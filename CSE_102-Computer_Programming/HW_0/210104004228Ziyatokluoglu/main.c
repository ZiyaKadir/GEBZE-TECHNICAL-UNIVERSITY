...
int main() {
    ...
    */
    ...
    printf("\n\nSet to two fraction numbers to do the same operation\n");
    printf("Enter numerator of first number: "); /* read numerator of first number*/
    scanf("%d", &num1);
    printf("Enter denominator of first number: "); /* read denominator of first number*/
    scanf("%d", &den1);
    printf("Enter numerator of second number: "); /* read numerator of second number*/
    scanf("%d", &num2);
    printf("Enter denominator of second number: "); /* read denominator of second number*/
    scanf("%d", &den2);
